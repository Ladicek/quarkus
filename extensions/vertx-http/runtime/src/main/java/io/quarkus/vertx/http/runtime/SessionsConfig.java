...
public class SessionsConfig {
    ...
    /**
     * The path on which the Vert.x Web {@code SessionHandler} is installed in the router,
     * as well as the session cookie path. The value is relative to {@code quarkus.http.root-path}.
     */
    ...
    /**
     * The {@code SameSite} attribute of the session cookie.
     */
    @ConfigItem
    public Optional<CookieSameSite> cookieSameSite; // TODO maybe not `Optional` and default to `strict`?

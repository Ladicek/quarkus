            ...
            .beanRegistrars(new InvokerHelperRegistrar(MyService.class, (bean, invokers) -> {
                for (MethodInfo invokableMethod : bean.getInvokableMethods()) {
                    invokers.accept(invokableMethod.name(), bean.createInvoker(invokableMethod)
                            .setInstanceTransformer(Transformers.class, "instance")
                            .setArgumentTransformer(0, Transformers.class, "argument")
                            .setReturnValueTransformer(Transformers.class, "returnValue")
                            .setExceptionTransformer(Transformers.class, "exception")
                            .build());
                }
            }))
            .build();
